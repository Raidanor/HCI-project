        ...
        <div className="badge-container">
            <div className="row">
                <div className="col-4 text-center">
                    ...
                    <img src={Picture1} alt="Badge1" className="grey badge-grey hover-effect badgebg" />
                ...
                <div className="col-4 text-center">
                    ...
                    <img src={Picture1} alt="Badge1" className="badge-colored hover-effect badgebg" />
                ...
                <div className="col-4 text-center">
                    ...
                    <img src={Picture1} alt="Badge1" className="badge-rounded rounded-circle border-glowing hover-effect badgebg" />
            ...
            <div className="row">
                <div className="col-4 text-center">
                    <img src={Picture2} alt="Badge2" className="grey badge-grey hover-effect badgebg" />
                    <div className="badge-text">Receive this badge once you've completed all your tasks for one week.</div>
                </div>
                <div className="col-4 text-center">
                    <img src={Picture2} alt="Badge2" className="badge-colored hover-effect badgebg" />
                    <div className="badge-text">Receive this badge once you've completed all your tasks for one week ten times.</div>
                </div>
                <div className="col-4 text-center">
                    <img src={Picture2} alt="Badge2" className="badge-rounded rounded-circle border-glowing hover-effect badgebg" />
            ...
            <div className="row">
                <div className="col-4 text-center">
                    <img src={Picture3} alt="Badge3" className="grey badge-grey hover-effect badgebg" />
                    <div className="badge-text">Receive this badge once you've completed all your tasks for one month.</div>
                </div>
                <div className="col-4 text-center">
                    <img src={Picture3} alt="Badge3" className="badge-colored hover-effect badgebg" />
                    <div className="badge-text">Receive this badge once you've completed all your tasks for one month six times.</div>
                </div>
                <div className="col-4 text-center">
                    <img src={Picture3} alt="Badge3" className="badge-rounded rounded-circle border-glowing hover-effect badgebg" />
