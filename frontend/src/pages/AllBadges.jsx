        ...
        <div className="badge-container">
            ...
            <div className="row">
                <div className="col-4">
                    ...
                    <div className="badge-text">Recieve this badge once you've completed all your tasks for one week.</div>
                </div>
                <div className="col-4">
                    <img src = {Picture2} alt="Badge2" className="badge-colored" /> 
                    <div  className="badge-text">Recieve this badge once you've completed all your tasks for one week ten times.</div>
                </div>
                <div className="col-4">
                    <img src = {Picture2} alt="Badge2" className="badge-rounded rounded-circle border-glowing" />
                    <div className="badge-text">Recieve this badge once you've completed all your tasks for one week 30 times.</div>
                </div>
            </div>
            <br />
            <div className="row">
                <div className="col-4">
                    ...
                    <div className="badge-text">Recieve this badge once you've completed all your tasks for one month.</div>
                </div>
                <div className="col-4">
                    <img src = {Picture3} alt="Badge3" className="badge-colored"/> 
                    <div className="badge-text">Recieve this badge once you've completed all your tasks for one month six times.</div>
                </div>
                <div className="col-4">
                    <img src = {Picture3} alt="Badge3" className="badge-rounded rounded-circle border-glowing" />
                    <div className="badge-text">Recieve this badge once you've completed all your tasks for one month twelve times.</div>
                </div>
            </div>
